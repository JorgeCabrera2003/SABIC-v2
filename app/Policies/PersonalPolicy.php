...
class PersonalPolicy
{
    ...
    {
        return $user->can('view_any_personal');
    }
    ...
    {
        return $user->can('create_personal');
    }
    ...
    {
        return $user->can('update_personal');
    }
    ...
    {
        return $user->can('delete_personal');
    }
    ...
    {
        return $user->can('delete_any_personal');
    }
    ...
    {
        return $user->can('restore_personal');
    }
    ...
    {
        return $user->can('restore_any_personal');
    }
    ...
    {
        return $user->can('reorder_personal');
    }
}
